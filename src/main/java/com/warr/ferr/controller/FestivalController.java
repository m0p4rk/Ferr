...
public class FestivalController {
    ...
    public String searchFestival(@RequestParam(required = false) String region,
        ...
        String requestUrl = String.format(
                "http://apis.data.go.kr/B551011/KorService1/searchFestival1?serviceKey=%s&eventStartDate=%s&eventEndDate=%s&areaCode=%s&listYN=Y&MobileOS=ETC&MobileApp=AppName&_type=json&numOfRows=4&pageNo=1",

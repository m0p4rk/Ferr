    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a href="/schedulelist" class="btn btn-primary">일정 관리</a>
                </li>
                <li class="nav-item">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button class="btn btn-warning btn-block" id="kakao-login-btn"><i class="fab fa-kakao"></i> 카카오 로그인</button>
                <div class="text-center">
                    <a href="/signup" class="btn btn-link">회원가입</a>
                    <a href="/signup-social" class="btn btn-link">카카오로 시작하기</a>
                </div>
            </div>
        </div>
    </div>

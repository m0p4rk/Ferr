...
<div class="container mt-5">
    ...
    <form id="registrationForm" action="/register" method="post">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="password1" name="password" placeholder="비밀번호" required> 
            <small class="form-text text-muted">비밀번호는 8~20자 사이이며, 숫자와 특수문자를 포함해야 합니다.</small>
        </div>
        <div class="form-group">
            <label for="confirmPassword">비밀번호 재확인:</label> 
            <input type="password" class="form-control" id="confirmPassword" placeholder="비밀번호 재확인" required>
            <div id="passwordConfirmFeedback" class="invalid-feedback">비밀번호가 일치하지 않습니다.</div>
        </div>
